...
public class FakeDatabaseStrategy implements DataAccessStrategy{
    ...
    public List<Category> getCategories() {
        Item test = new Item(fakedb.get(0).get("name"),fakedb.get(0).get("description"),fakedb.get(0).get("price"));
        Category temp1 = new Category("Appetizers");
        temp1.addItem(test);
        temp1.addItem(new Item(fakedb.get(1).get("name"),fakedb.get(1).get("description"),fakedb.get(1).get("price")));
        temp1.addItem(new Item(fakedb.get(2).get("name"),fakedb.get(2).get("description"),fakedb.get(2).get("price")));
        
        Category temp2 = new Category("Drinks");
        temp2.addItem(new Item(fakedb.get(3).get("name"),fakedb.get(3).get("description"),fakedb.get(3).get("price")));
        temp2.addItem(new Item(fakedb.get(4).get("name"),fakedb.get(4).get("description"),fakedb.get(4).get("price")));
        temp2.addItem(new Item(fakedb.get(5).get("name"),fakedb.get(5).get("description"),fakedb.get(5).get("price")));
        temp2.addItem(new Item(fakedb.get(6).get("name"),fakedb.get(6).get("description"),fakedb.get(6).get("price")));
        
        Category temp3 = new Category("Main Courses");
        temp3.addItem(new Item(fakedb.get(7).get("name"),fakedb.get(7).get("description"),fakedb.get(7).get("price")));
        temp3.addItem(new Item(fakedb.get(8).get("name"),fakedb.get(8).get("description"),fakedb.get(8).get("price")));
        temp3.addItem(new Item(fakedb.get(9).get("name"),fakedb.get(9).get("description"),fakedb.get(9).get("price")));
        temp3.addItem(new Item(fakedb.get(10).get("name"),fakedb.get(10).get("description"),fakedb.get(10).get("price")));
